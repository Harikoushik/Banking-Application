...
<table class="table table-dark">
  ...
  <c:forEach var="list" items="${accountModelList}">
    <tr>
      ...
      <c:if test="${not empty loan}">
          <td><a href="http://localhost:8080/Banking-App-master/user/loanReqForm?accId=${list.accountId}&&userId=${user.userId}" button type="button" class="btn btn-primary btn-sm">Apply For Loan</button></td>
      </c:if>
      <c:if test="${empty loan}">
