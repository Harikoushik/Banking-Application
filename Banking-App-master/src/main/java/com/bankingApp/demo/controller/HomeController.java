...
public class HomeController {
    ...
    @RequestMapping(value = "/Banking-App/save", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/Banking-App/loginPage", method = RequestMethod.GET)
    public String loginPage() {
        return "loginPage";
    }

    @RequestMapping(value = "/Banking-App/403", method = RequestMethod.GET)
